...
---
::: {#about-block style="margin: 20px; border-radius: 15px; padding: 10px; background-color: #F2EDE4;"}
...
::: {.grid}
::: {.g-col-5 style="margin: 20px; border-radius: 15px; padding: 10px; background-color: #F2EDE4;"}

:::

::: {.g-col-7 style="margin: 20px; border-radius: 15px; padding: 10px; background-color: #F2EDE4;"}
::: {.content-visible when-profile="english"}
