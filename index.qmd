...
---
::: {#about-block style="margin: 20px; border-radius: 15px; padding: 10px; background-color: #78c2ae;"}
...
::: {.grid}
::: {.g-col-5 style="margin: 20px; border-radius: 15px; padding: 10px; background-color: #78c2ae;"}
Work in progress

:::

::: {.g-col-7 style="margin: 20px; border-radius: 15px; padding: 10px; background-color: #78c2ae;"}
::: {.content-visible when-profile="english"}
